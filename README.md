...
------------
    ...
    │
    ├── setup.py           <- makes project pip installable (pip install -e .) so future_news_fund can be imported
    │
    ├── future_news_fund                <- Source code for use in this project.
    │   ├── __init__.py    <- Makes future_news_fund a Python module
    │   │
